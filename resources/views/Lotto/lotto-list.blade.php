        ...
        $.ajax({
                ...
                success: function(reponse) {               
                    ...
                    lottodata.forEach(item => {
                        ...
                        innerHtml += "<div class=\"col-md-4 col-6 mb-3\" onclick=\"searchLottoByShop("+item.id+")\">";

                        innerHtml += "    <div id=\"shop"+item.id+"\" class=\"card lotto-shop-list\" >";

                        innerHtml += "        <div class=\"card-body card-pd\">";

                        innerHtml += "        <h5 class=\"card-title m-0\">"+ item?.shop_name+" <span class=\"badge rounded-pill bg-warning text-dark float-end\">"+item.cnt+" ชุด</span></h5>";
        ...
        $.ajax({
                ...
                success: function(reponse) {               
                    ...
                    lottodata.forEach(item => {
                        ...
                        innerHtml += "<div class=\"card-body card-pd text-center\">";

                        innerHtml += "<p class=\"m-0\">";
